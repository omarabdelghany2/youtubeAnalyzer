...
from .views import FetchChannelTagsView ,SaveCategorizedVideosView,FetchCategorizedVideosByNameView,DeleteCategorizedVideosByNameView,GetCategorizedVideosNamesView,FetchYouTubeVideoDataView,DeleteCategorizedVideos,ReloadLastStateView
...
urlpatterns = [
    ...
    path("hide_tag/", DeleteCategorizedVideos.as_view(), name="fetch_youtube_data"),
    path("reload_last_State/", ReloadLastStateView.as_view(), name="fetch_youtube_data"),
